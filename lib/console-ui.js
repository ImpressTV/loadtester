...
var colors = require('cli-table2/node_modules/colors/safe');
...
function formatFinalStatsTable(totalStats) {
  ...
  table.push(['Best response time'].concat(format_value(totalStats.responseTime.min.toFixed(0), 1000, null, " ms")));
  table.push(['Slowest response time'].concat(format_value(totalStats.responseTime.max.toFixed(0), 4000, null, " ms")));
  table.push(['Mean response time'].concat(format_value(totalStats.responseTime.mean.toFixed(0), 1000, null, " ms")));
  table.push(['Slowest response at 95%'].concat(format_value(totalStats.responseTime.topAt['0.05'].toFixed(0), 4000, null, " ms")));
  table.push(['Slowest response at 99%'].concat(format_value(totalStats.responseTime.topAt['0.01'].toFixed(0), 4000, null, " ms")));
